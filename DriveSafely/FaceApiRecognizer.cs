...
namespace DriveSafely.FacialRecognition
{
    class FaceApiRecognizer : IFaceRecognizer
    {
        ...
        {
            _faceApiClient = new FaceServiceClient(GeneralConstants.OxfordAPIKey, "https://westeurope.api.cognitive.microsoft.com/face/v1.0");
        }
        #endregion
