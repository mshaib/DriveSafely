...
namespace DriveSafely
{
    ...
    /// </summary>
    public sealed partial class UnknownProfilePage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            try
            {
                ...
                UserProfileObject UnknownProfileParameters = e.Parameter as UserProfileObject;

                // Sets current user as the passed through Driver object
                currentUser = UnknownProfileParameters.Driver;
                // Sets the DriverNameBlock as the current user's name
                UnknownNameBlock.Text = currentUser.Name;

                // Sets the local WebcamHelper as the passed through intialized one
                webcam = UnknownProfileParameters.WebcamHelper;
            }
            catch
            {
